...
# explore: agg_table_filter_borken {
#   from: order_items
#   always_filter: {
#     filters: [agg_table_filter_borken.sale_price: ">0", agg_table_filter_borken.created_date: "120 days"]
#   }
#   aggregate_table: rollup_borken {
#     query: {
#       dimensions: [agg_table_filter_borken.sale_price, agg_table_filter_borken.created_date]
#       measures: [agg_table_filter_borken.total_sale_price]
#       filters: [agg_table_filter_borken.sale_price: ">0", agg_table_filter_borken.created_date: "120 days"]
#     }
