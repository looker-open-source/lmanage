...
def main(**kwargs):
    ...
    settings_metadata = py.Yaml(yaml_path=f'{yaml_split[0]}.yaml')
    look_metadata= py.Yaml(yaml_path=f'{yaml_split[0]}_look_content.yaml')
    dashboard_metadata = f'{yaml_split[0]}_dashboard_content.json'
